...
class ProcessLogHdr(CoreModel):
    ...
    total_files = models.IntegerField(
        default=0, db_column="plg_total_files", blank=True, null=True
    )
    files_processed = models.IntegerField(
        default=0, db_column="plg_files_processed", blank=True, null=True
    )
...
class DistributorAuditData(CoreModel):
    ...
    drug_name = models.CharField(
        db_column="dad_drug_name", blank=True, null=True, max_length=512
    )

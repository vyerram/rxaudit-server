...
class ProcessLogHdr(CoreModel):
    ...
    processed_count = models.IntegerField(
        db_column="plg_processed_count", blank=True, null=True
    )
    failed_count = models.IntegerField(
        db_column="plg_failed_count", blank=True, null=True
    )
    
    # NEW: Pharmacy file counts
    pharmacy_processed_count = models.IntegerField(
        db_column="plg_pharmacy_processed_count",
        blank=True,
        null=True,
        default=0
    )
    pharmacy_failed_count = models.IntegerField(
        db_column="plg_pharmacy_failed_count",
        blank=True,
        null=True,
        default=0
    )
    
    # NEW: Distributor file counts
    distributor_processed_count = models.IntegerField(
        db_column="plg_distributor_processed_count",
        blank=True,
        null=True,
        default=0
    )
    distributor_failed_count = models.IntegerField(
    ...
    failed_files_json = models.JSONField(
        db_column="plg_failed_files", blank=True, null=True
    )
